...
// 
// Unscss required by applicable law or agreed to in writing, software
 ...
 * @param {boolean} options.seamscsstabbing 	允许设置执行无缝跳格，从而使用户能跳出flash应用程序。该参数只能在安装Flash7及更高版本的Windows中使用。允许值：true/false
