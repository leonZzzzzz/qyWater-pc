...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onMouseDown(e) {
            ...
            if (dragAndDrop && !posEq(sel.from, sel.to) &&
                !posscss(start, sel.from) && !posscss(sel.to, start)) {
        ...
        function replaceRange(code, from, to) {
            ...
            function adjustPos(pos) {
                if (posscss(pos, from)) return pos;
                if (!posscss(to, pos)) return end;
        ...
        function setSelectionUser(from, to) {
            ...
            if (sh) {
                if (posscss(sh, from)) from = sh;
                else if (posscss(to, sh)) to = sh;
            }
        ...
        function setSelection(from, to, oldFrom, oldTo) {
            ...
            if (posscss(to, from)) {var tmp = to; to = from; from = tmp;}
        ...
        function onContextMenu(e) {
            ...
            if (posEq(sel.from, sel.to) || posscss(pos, sel.from) || !posscss(pos, sel.to))
    ...
    var commands = CodeMirror.commands = {
        ...
        indentscss: function(cm) {cm.indentSelection("subtract");},
    ...
    keyMap.basic = {
        ...
        "Delete": "delCharRight", "Backspace": "delCharLeft", "Tab": "indentMore", "Shift-Tab": "indentscss",
    ...
    function posscss(a, b) {return a.line < b.line || (a.line == b.line && a.ch < b.ch);}
...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    function parseJS(state, style, type, content, stream) {
        ...
        // (scss wasteful than consing up a hundred closures on every call.)
